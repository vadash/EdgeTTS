...
Leaf knowledge too detailed for the `AGENTS.md` routers. Read only the file matching your task.

- `services/tts-worker-pool_gotchas.md` — TTS WebSocket pool lifecycle, retries, cancellation, failure logs
...
- `llm/rate-limit_gotchas.md` — 429 concurrency collapse, cooldown timing, AIMD recovery, p-retry zeroing
